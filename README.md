# CTP_RISK_Python
CTP风控 python接口使用Swig技术开发，可以自己按以下步骤编译，需要安装swig等组件。swig转换文件参考[openctp](https://github.com/openctp/openctp-ctp-python)项目。
## Windows下封装步骤
准备VisualStudio 2022、Swig、Python3、boost、cmake，boost库用到的是locale库，用来转换字符集。
